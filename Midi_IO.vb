...
Imports X_Touch_Control.Midi_IO_Structures
...
Public Class Midi_IO
    ...
    'Private MidiInBuffer(MidiIn_NumberOfMessages) As MidiInMessage
    'Private MidiInReadPtr As Integer                              'msg-nr (0-511)
    'Private MidiInWritePtr As Integer                             'msg-nr (0-511)
    ...
    Const MidiInBuffer_SIZE = NumberOf_SYSX_IN_Buffers * SIZE_OF_1_SYSX_IN_BUFFER
    ...
    Public Function ProgStart() As Boolean
    ...
    Public Function ProgEnd() As Boolean
    ...
    Private Sub DisposeUnmanagedResources()
        ...
        Try
            ...
            '--- when Midi_IO was not finished with ProgEnd (which closes all MidiInPorts) then Free Memory here
...
#Region "Midi Output"
    Public Function OpenMidiOutPort(portName As String, ByRef hndRet As UInteger, dwInstance As Integer) As Boolean
        ...
        Debug.Print("OpenMidiOutPort: PortName = " & portName & " hndRet(Int) = " & hndRet.ToString & " dwInstance = " & dwInstance.ToString)
        ...
        portNr = GetPortNumberOut(portName)
    ...
    Private Function GetPortNumberOut(portName As String) As Integer
    ...
    Public Function OutLongMsg(hMidiOut As UInteger, src As Byte()) As Integer
        ...
        Dim ret As Integer = MMSYSERR_ERROR                         'return value
...
#Region "Midi Input"
    ...
    Public Function OpenMidiInPort(portName As String, ByRef hndRet As UInteger, dwInstance As Integer) As Boolean
        ...
        portNr = GetPortNumberIn(portName)
        If portNr = MIO_ERR_NOTFOUND Then
            last_error = MIO_ERR_NOTFOUND
            last_error_msg = "port not found"
            Return False
        ...
        Else
            ...
            PrepareSysxIn(portNr)                                     'all midihdrs and sysx_in buffers
    ...
    Public Sub CloseMidiInPort(hMidiIn As UInteger)
        ...
        Try
            ...
            UnPrepareSysxIn(ndx)                                    'all midihdrs and sysx_in buffers
            midiInClose(CType(MidiInPorts(ndx).hMidiIn, IntPtr))    'close port
        Catch ex As Exception
            Debug.Print("Error in CloseMidiInPort")
        End Try
    ...
    Private Function GetPortNumberIn(portName As String) As Integer
    ...
    Private Function PrepareSysxIn(ndx As Integer) As Boolean
        ...
        sysx_ptr = Marshal.AllocHGlobal(MidiInBuffer_SIZE)
    ...
    Private Function UnPrepareSysxIn(ndx As Integer) As Boolean
